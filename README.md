# Phone Number Validation API — Bulk Verification | NumberChecker

The **Phone Number Validation API** accepts a text file of phone numbers, creates an asynchronous bulk task, and exports a result file. This repository contains a runnable integration in seven languages.

- **Product page:** https://numberchecker.ai/products/phone-number-validation
- **API documentation:** https://docs.numberchecker.ai/phone-number-validation
- **API base URL:** `https://api.numberchecker.ai`
- **Authentication:** `X-API-Key`
- **Get an API key:** https://platform.numberchecker.ai

> [!NOTE]
> This repository covers the standalone product code `phoneCheck` only. Other product codes are outside its scope.

## Product facts

| API fact | Value |
|---|---|
| Product code | `phoneCheck` |
...
1. Submit the input file to `POST /v1/tasks` with `task_type=phoneCheck`.
...
Only `phoneCheck`. The task type is intentionally fixed to that product code.
...
- **Product:** https://numberchecker.ai/products/phone-number-validation
- **Documentation:** https://docs.numberchecker.ai/phone-number-validation
